...
app.use(morgan('dev'));
app.use(express.json({ limit: '10mb' })); // método que ayuda a convertir el código para que el servidor pueda entender lo que viene del cliente.
...
app.use('/api/pqrs',require('./routes/pqrs.route'));
